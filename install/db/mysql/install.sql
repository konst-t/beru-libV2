...
create table if not exists b_iplogicberu_business
(
	ID int(11) NOT NULL auto_increment,
	BID int(10) NOT NULL,
	NAME varchar(255) NULL,
	API_KEY varchar(255) NULL,
    BASE_PROFILE int(11) NULL,
	PRIMARY KEY (ID),
	INDEX (BID)
);
...
(
	...
	ORDER_PROD_ID int(11) NULL,
	IS_PART varchar(1) NOT NULL DEFAULT 'N',
	QUANTITY int(3) NULL,
	PART int(2) NULL,
	PARTS int(2) NULL,
	PRIMARY KEY (ID)
