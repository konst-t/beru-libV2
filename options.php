...
if($RIGHT >= "R") {
	...
	$arMainOptions = [
		...
		["dont_accept_orders", Loc::getMessage("IPL_DONT_ACCEPT_ORDERS"), "N", ["checkbox"]],
		["send_zero_stocks", Loc::getMessage("IPL_SEND_ZERO_STOCKS"), "N", ["checkbox"]],
		["fake_status_accept", Loc::getMessage("IPL_FAKE_STATUS_ACCEPT"), "N", ["checkbox"]],
	...
	if (Option::get($module_id, "can_execute_tasks") != "Y") {
		...
		$arMainOptions[] = ["can_execute_tasks", Loc::getMessage("IPL_SET_TASK_EXECUTE"), "N", ["checkbox"]];
	}
